import { Controller, Get, Post, Body, Param, Delete, Put, HttpCode, HttpStatus, Req, UseInterceptors, UploadedFile, ParseFilePipe, MaxFileSizeValidator } from '@nestjs/common';
