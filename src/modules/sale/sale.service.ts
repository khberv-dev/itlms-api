...
import { addMonths, differenceInDays, endOfMonth, isSameMonth, startOfMonth } from 'date-fns';
...
export class SaleService {
  ...
  async create(data: CreateSaleDto, seller_id: string, file: Express.Multer.File) {
    ...
    const new_sale = await this.saleRepository.create({
      ...sale,
      seller_id,
