import { Body, Controller, Get, HttpCode, HttpStatus, Param, Patch, Post, Query, Req, UploadedFiles, UseInterceptors } from "@nestjs/common";
...
export class AssignmentController {
    ...
    getMentorAssignments(
        @Req() req,
        @Query('groupId') group_id: string,
    ) {
        return this.assignmentService.getMentorAssignments(
            req.user.id,
            group_id
        );
    }
