...
export class AssignmentService {
    ...
    async getMentorAssignments(mentor_id: string, group_id: string) {
        const assignments = await this.repository.getMentorAssignments(
            mentor_id,
            group_id
        );
    ...
    async getAssignments(studentId: string) {
        const assignments =
            await this.repository.getStudentAssignments(studentId);
    ...
    async getAssignmentSubmissions(assignmentId: string) {
        ...
        const assignment =
            await this.repository.findAssignmentById(assignmentId);
