...
export class SaleStatisticController {
    ...
    getMonthlyConversion(
        ...
        return this.saleStatisticService.getMonthlyConversion(
            start_date,
            end_date,
        );
    }
    ...
    getSalesByAddress(
        ...
        return this.saleStatisticService.getSalesByAddress(
            start_date,
            end_date,
        );
    }
    ...
    getSalesByJob(
        ...
        return this.saleStatisticService.getSalesByJob(
            start_date,
            end_date,
        );
    }
    ...
    getSellersByAverageCheck(
        @Query('start_date') start_date: string,
        @Query('end_date') end_date: string,
    ) {
        return this.saleStatisticService.getSellersByAverageCheck(
            start_date,
            end_date,
        );
    }
