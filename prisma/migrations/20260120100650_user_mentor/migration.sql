-- AlterTable
ALTER TABLE "group" ADD COLUMN     "level_id" TEXT;
...
-- AddForeignKey
ALTER TABLE "group" ADD CONSTRAINT "group_level_id_fkey" FOREIGN KEY ("level_id") REFERENCES "group_level"("id") ON DELETE SET NULL ON UPDATE CASCADE;
