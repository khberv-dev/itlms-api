...
ALTER TABLE "group_monthly_snapshot"
    ADD COLUMN "h1_mentor_churn_rate" DOUBLE PRECISION,
...
ALTER
COLUMN "start_date" SET DEFAULT CURRENT_TIMESTAMP,
ALTER
COLUMN "start_date" SET DATA TYPE TIMESTAMP(3),
ALTER
COLUMN "end_date" SET DATA TYPE TIMESTAMP(3);
