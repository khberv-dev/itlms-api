...
-- AlterTable
ALTER TABLE "sale" ALTER COLUMN "sum" SET DATA TYPE DECIMAL(18,2),
ALTER COLUMN "seller_id" DROP NOT NULL;

-- AlterTable
ALTER TABLE "seller" ADD COLUMN     "amocrm_id" TEXT,
ADD COLUMN     "sip" INTEGER;

-- AlterTable
ALTER TABLE "student" ADD COLUMN     "access_expires_at" TIMESTAMP(3),
...
-- AddForeignKey
ALTER TABLE "sale" ADD CONSTRAINT "sale_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "seller"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "student" ADD CONSTRAINT "student_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "seller"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "seller_daily_statistic" ADD CONSTRAINT "seller_daily_statistic_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "seller"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "seller_month_plan" ADD CONSTRAINT "seller_month_plan_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "seller"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
