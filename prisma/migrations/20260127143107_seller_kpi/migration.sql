...
ALTER TABLE "seller_daily_kpi"
    ADD CONSTRAINT "seller_daily_kpi_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "seller" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "seller_monthly_kpi"
    ADD CONSTRAINT "seller_monthly_kpi_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "seller" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
